	...
	def actualiza(mapa):
		...
		def protectttgobif():
			if os.path.exists(ttgobifurl)==1:
				...
				print ("PROTEGIDO ARCHIVO 'ttgo.bif'...OK")
				print ("#")
				print ("#")
				os.system ("del /S /Q /A:-R %s" % ((uniex).rstrip('\\')))
				#os.system ("del /S /Q /A:-R %s" % ((uniex)))
				print ("BORRADO VOLUMEN COMPLETO...OK")
				print ("#")
				print ("#")
				os.system ("attrib -r %s" % (ttgobifurl))
				print ("RESTAURADO 'ttgo.bif'...OK")
				print ("#")
				print ("#")
			else:
		...
		if mapa==1:
			protectttgobif()
			print ("NAVCORE RECOMENDADO ACTUAL COPIA INICIADA...")
			...
			print ("MAPA IBERIA COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /E /Q /Y" % (pdis+'radares', uniex+'Iberia'))
			print ("PUNTOS DE INTERÉS BÁSICOS COPIADOS CON ÉXITO...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /Q /Y" % (mapas+'00_MAPSETTINGS\\mapsettings.cfg', uniex+'Iberia'))
			print ("CONFIGURADA ASOCIACIÓN PDI'S BÁSICOS + VOCES...OK")
			print ("#")
			print ("#")
			...
			print ("MAPA IBERIA NO-CARR COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /E /Q /Y" % (pdis+'radares', uniex+'Iberia\\'))
			print ("PUNTOS DE INTERÉS BÁSICOS COPIADOS CON ÉXITO...OK")
			...
			print ("#")
			print ("#")
			print ("MAPA SOUTH EUROPE COPIA INICIADA...")
			os.system ("xcopy %s %s /E /Q /Y" % (mapas+'South_Europe_2GB\\South_Europe', uniex+'South_Europe\\'))
			print ("MAPA SOUTH EUROPE COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
			print ("MAPA EASTERN EUROPE COPIA INICIADA...")
			os.system ("xcopy %s %s /E /Q /Y" % (mapas+'Eastern_Europe_basico\\Eastern_Europe', uniex+'Eastern_Europe\\'))
			print ("MAPA EASTERN EUROPE COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /E /Q /Y" % (pdis+'radares', uniex+'South_Europe\\'))
			print ("PUNTOS DE INTERÉS BÁSICOS COPIADOS CON ÉXITO EN SOUTH EUROPE...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /E /Q /Y" % (pdis+'radares_euro', uniex+'South_Europe\\'))
			print ("PUNTOS DE INTERÉS EUROPA COPIADOS CON ÉXITO EN SOUTH EUROPE...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /E /Q /Y" % (pdis+'sounds_radares_euro', uniex+'sounds\\Radar\\'))
			print ("SONIDOS PDIS EUROPA COPIADOS CON ÉXITO EN SOUTH EUROPE...OK")
			print ("#")
			print ("#")
			...
			print ("#")
			print ("#")
			print ("MAPA SOUTH EUROPE 1GB COPIA INICIADA...")
			os.system ("xcopy %s %s /E /Q /Y" % (mapas+'South_Europe_1GB\\South_Europe', uniex+'South_Europe\\'))
			print ("MAPA SOUTH EUROPE 1GB COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
			print ("MAPA EASTERN EUROPE COPIA INICIADA...")
			os.system ("xcopy %s %s /E /Q /Y" % (mapas+'Eastern_Europe_basico\\Eastern_Europe', uniex+'Eastern_Europe\\'))
			...
			print ("NAVCORE TRUCK ESPECIAL COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
			os.system ("xcopy %s %s /E /Q /Y" % (mapas+'Europe_TRUCK\\Europe_TRUCK\\', uniex))
			print ("MAPA EUROPE TRUCK COPIADO CON ÉXITO...OK")
			print ("#")
			print ("#")
		...
		print ("SONIDOS DE PUNTOS DE INTERÉS BÁSICOS COPIADOS CON ÉXITO...OK")
		print ("#")
		print ("#")
		os.system("xcopy %s %s /E /Q /Y" % (voces+'voices', uniex+'voices\\'))
		print ("VOCES PREGRABADAS MULTI-LENGUAJE COPIADAS CON ÉXITO...OK")
		print ("#")
		print ("#")
		os.system("cls")
		print ("#############################################")
